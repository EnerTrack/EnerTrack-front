...
@Component({
  ...
  imports: [NgxEchartsDirective, CardAnality], // Importa la directiva
  templateUrl: './dashboard-page.html',
  providers: [provideEchartsCore({ echarts })] // Importante: provider para el wrapper
})
export class DashboardPageComponent {
  ...
  //######### Grafica #2 ############################
  optionb: echarts.EChartsCoreOption = {
    title: {
